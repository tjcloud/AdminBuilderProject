			...
			<ul class="sidebar-menu">
				...
				<li class="treeview <?php if($current_class == 'contacts'){ ?>active<?php } ?>">
					<a href="index.html" class="waves-effect">
						<i class="fa fa-users"></i> <span>Contact Management</span> <i class="fa fa-angle-left pull-right"></i>
					</a>
					<ul class="treeview-menu">
						<li class="<?php if(($current_method == 'create' || $current_method == 'edit')){ ?>active<?php } ?>"><a href="<?php echo base_url().'contacts/create'; ?>"><i class="fa fa-user-plus"></i>Create Contact</a></li>
						<li class="<?php if($current_method == 'index'){ ?>active<?php } ?>"><a href="<?php echo base_url().'contacts'; ?>"><i class="fa fa-address-book"></i>Manage Contact</a></li>
					</ul>
				</li>
				<li>
					<a href="<?php echo base_url();?>attendance" class="waves-effect">
						<i class="fa fa-sign-in"></i> <span>Add Attendance</span>
					</a>
				</li>
				<li>
					<a href="<?php echo base_url();?>payment_report" class="waves-effect">
						<i class="fa fa-money"></i> <span>Payment Report</span>
					</a>
				</li>
				<li>
					<a href="<?php echo base_url();?>profit_report" class="waves-effect">
						<i class="fa fa-money"></i> <span>Profit Report</span>
					</a>
				</li>
			</ul>
		</div>
