...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->response = array();
        $this->options = array(
            'script_url' => SITE_URL.'/admin/import/do_upload',
            'upload_dir' => '../uploads/import_image/',
            'upload_url' => '../uploads/import_image/',
            ...
            'accept_file_types' => '/\.(gif|jpe?g|png|doc|docx|pdf)$/i',
