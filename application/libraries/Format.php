...
class Format {
	...
	public function __construct($data = NULL, $from_type = NULL)
	{
		...
		if ($from_type !== NULL)
		{
			if (method_exists('_from_' . $from_type))
			{
				$data = call_user_func('_from_' . $from_type, $data);
			}
	...
	public function to_array($data = NULL)
	{
		...
		if ($data === NULL && ! func_num_args())		{			$data = $this->_data;		}
		$array = array();		foreach ((array) $data as $key => $value)		{			if (is_object($value) || is_array($value))
			{
